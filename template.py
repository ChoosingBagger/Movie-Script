# Still needs template title logic
class Template(object):
    def build(
        self, thread_movie_title, director, imgLink, imdb_link, tmdb_link, rt_link,
        bluray_link, plot_summary, file_name, movie_distributor, country,
        imdb_year, movie_title, bbcode="SCREENS"
    ):
        source = "TBD"
        # if args.source:
        #    source = args.source
...
"""
        # self.threadTitle(thread_movie_title)

    # def threadTitle(self, title)
